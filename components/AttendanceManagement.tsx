          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <div className="space-y-1">
              ...
              <input 
                ...
                onChange={e => editingRecord ? setEditingRecord({...editingRecord, date: e.target.value}) : setNewRecord({ ...newRecord, date: e.target.value })}
            ...
            <div className="space-y-1">
              ...
              <select 
                ...
                onChange={e => editingRecord ? setEditingRecord({...editingRecord, studentId: e.target.value}) : setNewRecord({ ...newRecord, studentId: e.target.value })}
                className="w-full p-2.5 text-[10px] input-cyber rounded-xl focus:border-primary focus:ring-primary outline-none"

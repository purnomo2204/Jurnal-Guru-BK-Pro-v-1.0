                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-xs font-black text-slate-800 uppercase tracking-tighter leading-none mb-1">
                            {s.name}
                          </div>
                      ...
                      <span className="text-[9px] font-black px-2 py-1 rounded-lg border border-indigo-100 bg-indigo-50 text-indigo-600">
                        No. ABSEN: {s.attendanceNumber || "-"}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[10px] bg-slate-50 p-2 rounded-xl border border-slate-100">
                      ...
                      <div>
                        ...
                        <span className="font-bold text-slate-700">
                          {s.gender} - Absen {s.attendanceNumber || "-"}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 justify-end mt-1">
                      {s.parentPhoneWA && (
                        <button
                          ...
                          className="p-2 flex-1 flex justify-center items-center bg-white border border-slate-200 hover:bg-emerald-50 rounded-xl text-emerald-600 transition-all shadow-sm"
                        >
                      ...
                      <button
                        onClick={() => handleCopyAkpdLink(s)}
                        className="p-2 flex-1 flex justify-center items-center bg-white border border-slate-200 hover:bg-blue-50 rounded-xl text-blue-600 transition-all shadow-sm"
                      >
                        <Link className="w-4 h-4" />
                      </button>
                      <button
                        onClick={() => onOpenPersonalBook(s.id)}
                        className="px-3 py-2 flex-[2] flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 border border-indigo-500/50 rounded-xl text-white transition-all shadow-md gap-1 text-[10px] font-black uppercase tracking-widest"
                      >
                        <BookOpen className="w-4 h-4" /> BUKU
                      </button>
                      <button
                        onClick={() => startEdit(s)}
                        className="p-2 flex-1 flex justify-center items-center bg-white border border-slate-200 hover:bg-primary/10 rounded-xl text-primary transition-all shadow-sm gap-1 text-[10px] font-black uppercase tracking-widest"
                      >
                        <Edit className="w-4 h-4" /> EDIT
                      </button>
                      <button
                        onClick={() => setStudentToDelete(s.id)}
                        className="p-2 flex-1 flex justify-center items-center bg-white border border-slate-200 hover:bg-rose-50 rounded-xl text-rose-500 transition-all shadow-sm gap-1 text-[10px] font-black uppercase tracking-widest"
                      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm p-4">
          <div className="bg-white border border-slate-100 p-8 rounded-[2rem] shadow-2xl max-w-sm w-full text-center">
            ...
            <button
              ...
              className="w-full py-4 bg-blue-600 text-white font-black rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 text-[10px] uppercase tracking-widest"
            >
              TUTUP
            </button>
          </div>

      ...
      <div className="max-w-7xl mx-auto">
        {loading ? (
          ...
          <div className="space-y-6">
            {['PROGRAM BK', 'RPLBK', 'LKPD', 'MATERI', 'TDA', 'TES NON TES', 'SERTIFIKAT', 'SK', 'DOKUMEN KEPEGAWAIAN', 'LAINNYA'].map(category => {
            ...
            <form onSubmit={handleUpdate} className="p-5 space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs outline-none focus:ring-2 focus:ring-amber-500/20 transition-all"
                >
                  {['PROGRAM BK', 'RPLBK', 'LKPD', 'MATERI', 'TDA', 'TES NON TES', 'SERTIFIKAT', 'SK', 'DOKUMEN KEPEGAWAIAN', 'LAINNYA'].map(cat => (
